...
class Article(models.Model):
    ...
    intro = models.CharField(max_length=1000,blank=None,null=None)  # 导语
...
class Best(models.Model):
    # 精选文章
    select_article = models.ForeignKey(Article, related_name='select_article')  # 被精选选的文章
    SELECT_REASON = (
        ('今日新闻', '今日新闻'),
        ('首页推荐', '首页推荐'),
        ('编辑推荐', '编辑推荐')
...
class Comment(models.Model):
    ...
    to_user = models.ForeignKey(User, related_name='to_user', null=True)  # 回复的人
